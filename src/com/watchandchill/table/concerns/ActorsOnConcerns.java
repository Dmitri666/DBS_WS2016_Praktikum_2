...
public class ActorsOnConcerns extends Table {
    ...
    public String getSelectQueryForRowWithData(Data data) throws SQLException {
        return "SELECT Benutzername AS  \"Schauspieler \" ,Bezeichnung AS  \"Bezeichnung von Medienkonzern\" FROM Steht_unter_Vertrag " + "" +
    ...
    public void insertRowWithData(Data data) throws SQLException {
        ...
        preparedStatement.setObject(2, data.get("Steht_unter_Vertrag.Bezeichnung von Medienkonzern"));
    ...
    public void updateRowWithData(Data oldData, Data newData) throws SQLException {
        ...
        preparedStatement.setObject(2, newData.get("Steht_unter_Vertrag.Bezeichnung von Medienkonzern"));
