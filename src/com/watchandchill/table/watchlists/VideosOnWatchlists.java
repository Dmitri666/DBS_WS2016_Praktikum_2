...
public class VideosOnWatchlists extends Table {
    ...
    public String getSelectQueryForTableWithFilter(String filter) throws SQLException {
        String selectQuery = "SELECT E.WatchlistId ,W.Bezeichnung ,E.Bezeichnung AS \"Video\" FROM Enthalt E " +
    ...
    public String getSelectQueryForRowWithData(Data data) throws SQLException {
        return "SELECT WatchlistId AS \"ID von Watchlist\", Bezeichnung AS \"Bezeichnung von Video\" FROM Enthalt WHERE WatchlistId = " + data.get("Enthalt.WatchlistId") +
    ...
    public void insertRowWithData(Data data) throws SQLException {
        ...
        preparedStatement.setObject(1, data.get("Enthalt.Bezeichnung von Video"));
    ...
    public void updateRowWithData(Data oldData, Data newData) throws SQLException {
        ...
        preparedStatement.setObject(2, newData.get("Enthalt.WatchlistId"));
        preparedStatement.setObject(3, oldData.get("Enthalt.Bezeichnung von Video"));
    ...
    public void deleteRowWithData(Data data) throws SQLException {
        ...
        preparedStatement.setObject(1, data.get("Gehort_an.Video"));
        preparedStatement.setObject(2, data.get("Gehort_an.WatchlistId"));
        preparedStatement.executeUpdate();
    }
}
