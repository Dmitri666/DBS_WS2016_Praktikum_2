...
FOREIGN KEY(Bezeichnung) REFERENCES Video(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE
);
...
Bezeichnung text NOT NULL,
FOREIGN KEY(Benutzername) REFERENCES Premium_Nutzer(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Bezeichnung) REFERENCES Film(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE
);
...
StaffelId integer NOT NULL,
FOREIGN KEY(Benutzername) REFERENCES Premium_Nutzer(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(StaffelId) REFERENCES Staffel(ID) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(Bezeichnung) REFERENCES Film(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Benutzername) REFERENCES Schauspieler(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(Medienkonzert_Bezeichnung) REFERENCES Medienkonzern(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Film_Bezeichnung) REFERENCES Film(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(Video_Bezeichnung) REFERENCES Video(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Genre_Bezeichnung) REFERENCES Genre(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE
);
...
FOREIGN KEY(Benutzername) REFERENCES Premium_Nutzer(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Benutzername1) REFERENCES Premium_Nutzer(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE
);
...
PRIMARY KEY (Benutzername,Bezeichnung),
FOREIGN KEY(Benutzername) REFERENCES Schauspieler(Benutzername) ON UPDATE CASCADE ON DELETE CASCADE,
FOREIGN KEY(Bezeichnung) REFERENCES Medienkonzern(Bezeichnung) ON UPDATE CASCADE ON DELETE CASCADE
);
